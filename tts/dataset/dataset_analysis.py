...
def init_pipeline(mode: str = 'train', multilingual: bool = True, num_languages: int = 100, language: str = 'en',
                  ...
                  batch_type: str = 'dynamic', max_frames_in_batch: int = 2000) -> List[Callable]:
    pipeline = []
    ...
    pipeline.append(partial(resample, sample_rate=sample_rate))
    ...
    pipeline.append(padding)
    return pipeline


def init_dataset_and_dataloader(data_list_file, gan: bool = False, pin_memory: bool = False, num_workers: int = 0,
